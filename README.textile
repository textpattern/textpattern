...
!http://textpattern.com/assets/img/branding/textpattern/textpattern.svg(Textpattern Logo)!:http://textpattern.com
...
The development version can be checked out from the "Textpattern repository on GitHub":https://github.com/textpattern/textpattern. Note that development versions are not recommended for use in live production servers.
