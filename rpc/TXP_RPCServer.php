...
//---------------------------------------------------------
    ...
    function blogger_getPost($params)
    {
        ...
        $rs = $txp->getArticleID($postid, 'ID, Body, AuthorId, ' . txp_timestamp('Posted', 'uPosted'));
    ...
    function blogger_getRecentPosts($params)
    {
        ...
        $articles = $txp->getArticleList('ID, Body, AuthorId, ' . txp_timestamp('Posted', 'uPosted'), "Section='" . doSlash($blogid) . "'", '0', $numberOfPosts, false);
...
//---------------------------------------------------------
    ...
    function metaWeblog_getPost($params)
    {
        ...
        $rs = $txp->getArticleID($postid, 'ID, Title, Body, Excerpt, Annotate, Keywords, Section, Category1, Category2, textile_body, url_title, ' . txp_timestamp('Posted', 'uPosted'));
    ...
    function metaWeblog_getRecentPosts($params)
    {
        ...
        $articles = $txp->getArticleList(
            'ID, Title, url_title, Body, Excerpt, Annotate, Keywords, Section, Category1, Category2, textile_body, AuthorID, Status, ' . txp_timestamp('Posted', 'uPosted'),
...
//---------------------------------------------------------
    ...
    function mt_getRecentPostTitles($params)
    {
        ...
        $articles = $txp->getArticleList('ID, Title, AuthorID, ' . txp_timestamp('Posted', 'uPosted'), "Section='" . doSlash($blogid) . "'", '0', $numberOfPosts, false);
