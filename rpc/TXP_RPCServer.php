...
//---------------------------------------------------------
    ...
    function blogger_getPost($params)
    {
        ...
        $rs = $txp->getArticleID($postid, 'ID, Body, AuthorId, TIMESTAMPDIFF(SECOND, "'.UNIXTIME_ZERO.'", Posted) as uPosted');
    ...
    function blogger_getRecentPosts($params)
    {
        ...
        $articles = $txp->getArticleList('ID, Body, AuthorId, TIMESTAMPDIFF(SECOND, "'.UNIXTIME_ZERO.'", Posted) as uPosted', "Section='" . doSlash($blogid) . "'", '0', $numberOfPosts, false);
...
//---------------------------------------------------------
    ...
    function metaWeblog_getPost($params)
    {
        ...
        $rs = $txp->getArticleID($postid, 'ID, Title, Body, Excerpt, Annotate, Keywords, Section, Category1, Category2, textile_body, url_title, TIMESTAMPDIFF(SECOND, "'.UNIXTIME_ZERO.'", Posted) as uPosted');
    ...
    function metaWeblog_getRecentPosts($params)
    {
        ...
        $articles = $txp->getArticleList(
            'ID, Title, url_title, Body, Excerpt, Annotate, Keywords, Section, Category1, Category2, textile_body, AuthorID, TIMESTAMPDIFF(SECOND, "'.UNIXTIME_ZERO.'", Posted) as uPosted, Status',
...
//---------------------------------------------------------
    ...
    function mt_getRecentPostTitles($params)
    {
        ...
        $articles = $txp->getArticleList('ID, Title, AuthorID, TIMESTAMPDIFF(SECOND, "'.UNIXTIME_ZERO.'", Posted) as uPosted', "Section='" . doSlash($blogid) . "'", '0', $numberOfPosts, false);
