...
class TagBuilderTags
{
    ...
    public static function tag($name)
    {
        ...
        self::$tagname = gps('tag_name');

        $method = 'tag_'.self::$tagname;

        if (method_exists($tagbuilder, $method)) {
            self::$startblock = hed(
                    gTxt('tag_'.self::$tagname).
                    sp . href(
                        'i',
                        'http://www.textpattern.net/wiki/index.php?title='.self::$tagname,
                        array(
                            'rel'        => 'help',
                            'target'     => '_blank',
                            'class'      => 'pophelp',
            ...
            self::$endform = graf(
                ...
                eInput('tag').
                sInput('build').
                hInput('tag_name', self::$tagname);

            return $tagbuilder->$method(self::$tagname);
        }
    ...
    private function build($atts, $thing = '')
    {
        ...
        if ($step === 'build') {
            $out = $this->tdb($this->tb(self::$tagname, $atts, $thing));
        }
    ...
    function tag_category_list()
    {
        ...
        $out = $this->tagbuildForm(
            ...
            $this->widgets(array(
                ...
                'label'                 => $this->tbInput('label', ($label ? $label : gTxt('categories')), INPUT_REGULAR),
                'labeltag'              => $this->tbInput('labeltag', $labeltag),
                'wraptag'               => $this->tbInput('wraptag', $wraptag),
                'class'                 => $this->tbInput('class', $class, INPUT_REGULAR),
    ...
    function tag_if_section()
    {
        ...
        $out = $this->tagbuildForm(
            self::$startblock.
            $this->widget('name', $this->tbSectionPop('name', self::$tagname)).
            self::$endform
        ).
        $this->build($atts, gTxt('...'));
        ...
        $out = $this->tagbuildForm(
            ...
            $this->widgets(array(
                'link_text' => $this->tbInput(
                                    'linktext',
                                    ($linktext !== null ? $linktext : gTxt('tag_home')),
                                    INPUT_REGULAR,
                                    'link_text'
                                ),
                'class'     => $this->tbInput('class', $class, INPUT_REGULAR),
    ...
    function tag_link_to_next()
    {
        ...
        $out = $this->tagbuildForm(
            ...
            $this->widgets(array(
                'link_text'  => $this->tbInput(
                                    'linktext',
                                    ($linktext !== null ? $linktext : '<txp:next_title />'),
                                    INPUT_REGULAR,
                                    'link_text'
                                ),
    ...
    function tag_link_to_prev()
    {
        ...
        $out = $this->tagbuildForm(
            ...
            $this->widgets(array(
                'link_text'  => $this->tbInput(
                                    'linktext',
                                    ($linktext !== null ? $linktext : '<txp:prev_title />'),
                                    INPUT_REGULAR,
                                    'link_text'
                                ),
                'showalways' => $this->tbYesNoPop('showalways', $showalways),
    ...
    function tag_permlink()
    {
        ...
        $out = $this->tagbuildForm(
            ...
            $this->widgets(array(
                ...
                'link_text'    => $this->tbInput(
                                    'linktext',
                                    ($linktext !== null ? $linktext : '<txp:title />'),
                                    INPUT_REGULAR,
                                    'link_text'
                                ),
                'title'        => $this->tbInput('title', $title, INPUT_REGULAR),
    ...
    function tag_popup()
    {
        ...
        $out = $this->tagbuildForm(
            ...
            $this->widgets(array(
                ...
                'section'      => $this->tbSectionPop('section', $section),
                'this_section' => $this->tbYesNoPop('this_section', $this_section),
                'label'        => $this->tbInput('label', ($label ? $label : gTxt('browse')), INPUT_REGULAR),
                'wraptag'      => $this->tbInput('wraptag', $wraptag),
                'class'        => $this->tbInput('class', $class, INPUT_REGULAR),
            )).
            self::$endform
    ...
    function tag_recent_articles()
    {
        ...
        $out = $this->tagbuildForm(
            ...
            $this->widgets(array(
                ...
                'sort'     => $this->tbSortPop($sort),
                'limit'    => $this->tbInput('limit', $limit, INPUT_TINY),
                'label'    => $this->tbInput('label', ($label ? $label : gTxt('recent_articles')), INPUT_REGULAR),
                'labeltag' => $this->tbInput('labeltag', $labeltag),
                'wraptag'  => $this->tbInput('wraptag', $wraptag),
                'break'    => $this->tbInput('break', $break),
            )).
    ...
    function tag_search_input()
    {
        ...
        $out = $this->tagbuildForm(
            ...
            $this->widgets(array(
                ...
                'label'       => $this->tbInput('label', ($label ? $label : gTxt('search')), INPUT_REGULAR),
                'wraptag'     => $this->tbInput('wraptag', $wraptag),
                'class'       => $this->tbInput('class', $class, INPUT_REGULAR),
    ...
    function tag_section()
    {
        ...
        $out = $this->tagbuildForm(
            self::$startblock.
            $this->widgets(array(
                'name'                 => $this->tbSectionPop('name', self::$tagname),
