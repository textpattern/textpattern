    ...
    if ($total < 1) {
        ...
        $rs = safe_query(
            "SELECT
                ...
                txp_discuss.message,
                txp_discuss.visible,
                " . txp_timestamp(array('txp_discuss.posted' => 'posted')) . ",
                ...
                textpattern.Status,
                " . txp_timestamp(array('textpattern.Posted' => 'uPosted')) . ",
...
function discuss_edit()
{
    ...
    $rs = safe_row("*, " . txp_timestamp(array('posted' => 'uPosted')), 'txp_discuss', "discussid = '$discussid'");
