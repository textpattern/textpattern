...
class Textpattern_Meta_ContentTypes implements IteratorAggregate
{
    /**
     ...
     *
     * The map can be extended with a 'content.types > types' callback event.
    ...
    public function __construct($exclude = array())
    {
        ...
        callback_event_ref('content.types', 'types', 0, $map);
    }
