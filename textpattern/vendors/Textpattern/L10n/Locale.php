...
class Locale
{
    ...
    protected $locales = array(
        ...
        'nb' => array('nb_NO.UTF-8', 'nb_NO.ISO_8859-1', 'Norwegian_Norway.1252', 'nn_NO', 'no', 'nn', 'nor', 'nno', 'nb', 'nob', 'norwegian'),
        ...
        'sr-cs' => array('sr_RS.UTF-8', 'Serbian (Cyrillic)_Serbia and Montenegro.1251', 'sr_RS', 'sr', 'sp', 'srb', 'serbian'),
        'sr' => array('sr_SP.UTF-8', 'Serbian (Cyrillic)_Serbia and Montenegro.1251', 'sr_SP', 'sr', 'sp', 'srb', 'serbian'),
