...
// Ugly way to change somethign which could break BC: changed use_textile == 2 to convert breaks and
// use_textile == 1 to use textile - the same than in textile_body or textile_excerpt.
