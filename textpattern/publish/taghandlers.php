 ...
 */
	...
	Txp::get('TagRegistry')
		...
		->register(array('Textpattern_Tag_Syntax_Partial', 'if_yield'), 'if_yield')
		->register('feed_link')
		...
		->register('link_id')
		->register(array('Textpattern_Tag_Syntax_Link', 'if_first_link'), 'if_first_link')
		->register(array('Textpattern_Tag_Syntax_Link', 'if_last_link'), 'if_last_link')
		->register('email')
		...
		->register(array('Textpattern_Tag_Syntax_Authors', 'authors'), 'authors')
		->register('author')
		...
		->register('image_date')
		->register(array('Textpattern_Tag_Syntax_Image', 'if_first_image'), 'if_first_image')
		->register(array('Textpattern_Tag_Syntax_Image', 'if_last_image'), 'if_last_image')
		...
		->register(array('Textpattern_Tag_Syntax_File', 'if_first_file'), 'if_first_file')
		->register(array('Textpattern_Tag_Syntax_File', 'if_last_file'), 'if_last_file')
		->register('hide')
		->register('rsd')
		->register('variable')
