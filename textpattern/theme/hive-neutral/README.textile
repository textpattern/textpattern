h1. Hive admin-side theme (Neutral Grey) for Textpattern CMS
...
# Upload the directory 'hive-neutral' into your Textpattern installation -> theme directory.
# Log in to your Textpattern admin area. Navigate to admin -> preferences -> advanced.
# Select 'Hive (Neutral Grey)' from the 'Admin-side theme' dropdown list. Save the preferences.
